...
const files=['hotelbedsAccess','hotelbedsScale','hotelbedsCatalogReadiness','hotelbedsMultiDestination','hotelbedsContent','hotelbedsPublicSearch','hotelbedsStagingTest','hotelbedsReadOnly','hotelbedsLive','hotelbedsIsolation'];
(async()=>{
