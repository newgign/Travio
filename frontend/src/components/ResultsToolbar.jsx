...
export default function ResultsToolbar({total,shown,activeCount,sort,local,open,onOpen,onSort,triggerRef}) {
  return <div className="results-toolbar"><div className="results-count" aria-live="polite"><strong>Найдено {hotelCount(total)}</strong>{activeCount>0 && <span>Показано {shown} из {total}</span>}</div>
